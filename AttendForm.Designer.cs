...
partial class AttendForm
{
    ...
    private void InitializeComponent()
    {
        ...
        tbFontSize.Margin = new Padding(2, 2, 2, 2);
        ...
        txtbIgnoreLevel.Margin = new Padding(2, 2, 2, 2);
        ...
        txtBoxStable.Margin = new Padding(2, 2, 2, 2);
        ...
        txtBoxStartColumn.Margin = new Padding(2, 2, 2, 2);
        ...
        tbSelfDefWeek.Margin = new Padding(2, 2, 2, 2);
        ...
        btnCalculateAllExcel.Margin = new Padding(2, 2, 2, 2);
        ...
        Name = "AttendForm";
        Text = "點名系統表單整理小幫手 v1.0 20240922";
