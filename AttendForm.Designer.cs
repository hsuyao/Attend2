...
partial class AttendForm
{
    ...
    private void InitializeComponent()
    {
        ...
        cbAllDisplayLastAttend = new CheckBox();
        cbDisplayLastAttend = new CheckBox();
        label4 = new Label();
        ...
        // tabPage5
        // 
        tabPage5.Controls.Add(cbAllDisplayLastAttend);
        tabPage5.Controls.Add(cbDisplayLastAttend);
        ...
        // 
        // cbAllDisplayLastAttend
        // 
        cbAllDisplayLastAttend.AutoSize = true;
        cbAllDisplayLastAttend.Checked = true;
        cbAllDisplayLastAttend.CheckState = CheckState.Checked;
        cbAllDisplayLastAttend.Location = new Point(346, 62);
        cbAllDisplayLastAttend.Name = "cbAllDisplayLastAttend";
        cbAllDisplayLastAttend.Size = new Size(158, 19);
        cbAllDisplayLastAttend.TabIndex = 31;
        cbAllDisplayLastAttend.Text = "標示聚會紀錄於到會人位";
        cbAllDisplayLastAttend.UseVisualStyleBackColor = true;
        // 
        // cbDisplayLastAttend
        // 
        cbDisplayLastAttend.AutoSize = true;
        cbDisplayLastAttend.Checked = true;
        cbDisplayLastAttend.CheckState = CheckState.Checked;
        cbDisplayLastAttend.Location = new Point(346, 34);
        cbDisplayLastAttend.Name = "cbDisplayLastAttend";
        cbDisplayLastAttend.Size = new Size(98, 19);
        cbDisplayLastAttend.TabIndex = 30;
        cbDisplayLastAttend.Text = "標示聚會紀錄";
        cbDisplayLastAttend.UseVisualStyleBackColor = true;
        // 
        // label4
        // 
    ...
    private CheckBox cbAllDisplayLastAttend;
    private CheckBox cbDisplayLastAttend;
}
